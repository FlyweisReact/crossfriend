...
const Payment = () => {
  ...
  return (
    <>
      <PlaceOrder show={modalShow} onHide={() => setModalShow(false)} />
      ...
      <div className="cart_container">
        <div className="left_container">
          ...
          <form>
            ...
            <div className="two_sec">
              ...
              <div>
                ...
                <input type="text" placeholder="467" />
              </div>
            </div>
          </form>
          ...
          <div className="Heading mt-3">
            <img src="/Image/83.png" alt="" />
            <p>Use Redeem Points</p>
          </div>

          <div className="Heading mt-3">
            <p style={{ color: "#FF6161", fontWeight: "bold" }}>
              Have a voucher?
            </p>
            <p style={{ color: "#FF6161", fontWeight: "bold" }}>
              click in here
        ...
        <div className="right_container">
          ...
          <button className="place_order" onClick={() => setModalShow(true)}>
            Pay Now
          </button>
        </div>
      </div>
