        ...
        <div className="left_container">
          ...
          <form>
            ...
            <div className="mt-3">
              ...
              <input type="text" placeholder="XYZ Road"       onChange={(e) => setStreet2(e.target.value)} />
            </div>

            <div className="two_sec">
              <div>
                <p className="title">City</p>
                <input type="text" placeholder=" Delhi"       onChange={(e) => setCity(e.target.value)} />
              </div>
              <div>
                <p className="title">Pincode</p>
                <input type="text" placeholder="201009"       onChange={(e) => setStreet1(e.target.value)} />
              </div>
            </div>
            <div className="two_sec">
              <div>
                <p className="title">State</p>
                <input type="text" placeholder=" Delhi"       onChange={(e) => setStreet1(e.target.value)} />
              </div>
              <div>
                <p className="title">Country</p>
                <input type="text" placeholder="India"       onChange={(e) => setStreet1(e.target.value)} />
              </div>
            </div>
          </form>
