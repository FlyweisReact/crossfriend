...
import { addToCart, getProductbyQuery, getProductDetail } from "../Repository/Api";
...
const SingleProduct = () => {
  ...
  const payload = { product : id , sizeId , quantity  }
        ...
        <div className="right-container">
          ...
          <div className="sizes">
            {product?.sizePrice?.map((i, index) => (
              <p key={index} className={sizeId === i._id ? }  onClick={() => setSizeId(i._id)} > {i.weight} </p>
            ))}
          </div>
