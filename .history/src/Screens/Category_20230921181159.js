...
import RoundProduct from "../Components/static/RoundProduct";
...
const Category = () => {
  ...
  return (
    <>
      ...
      <RoundProduct data={elegantFlowers} />
      <div className="border-line"></div>
      
      <div className="Category_Heading">
        <p className="title">Tempting Cakes</p>
        <button>view all</button>
      </div>
      <RoundProduct data={cakes} />
      <div className="border-line"></div>
            
      <div className="Category_Heading">
        <p className="title">Personalised Gifts </p>
        <button>view all</button>
      </div>
      <RoundProduct data={gifts} />
      <div className="border-line"></div>
    </>
  );
};
